...
static NSString *githubURL = @"https://github.com/ImBIOS/mute-me";
static NSString *projectURL = @"https://blog.imam.dev/";
...
- (IBAction)onLoginStartChanged:(id)sender {
    ...
    if(SMLoginItemSetEnabled((__bridge CFStringRef)@"ImBIOS.Mute-Me-Now-Launcher", enableState)) {
